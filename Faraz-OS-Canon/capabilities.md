...
- **Boundary notes.**
  ...
  - Inherited Phase 1 question, referenced not resolved: what belongs
    ...
    capability is open (`domains.md:1939-1940`; noted overlap at
    `domains.md:1929-1930`), and CRM models its own *CRM Reporting &
...
- **Boundary notes.**
  ...
  - Sequence (Phase 6): the produce-asset ability only. The
    ...
    (`domains.md:3364`, `:3397`, `:3434`) — a workflow that invokes
...
- **Boundary notes.**
  ...
  - Inherited Phase 1 question, referenced not resolved: what belongs
    in the Intelligence domain versus the Analytics / Reporting
    capability is open (`domains.md:1939-1940`; noted overlap at
    `domains.md:1929-1930`). The Serves value above is therefore a Phase 3
...
- **Serves.** Serves CRM and Intelligence (Phase 3 inference,
  ...
  `domains.md:1942-1943`; see Boundary notes). Stated at naming
...
- **Boundary notes.**
  ...
  - Inherited Phase 1 question, referenced not resolved: whether lead
    ...
    domain-local logic is open (`domains.md:1942-1943`; Intelligence's
    Scoring & Prioritization context at `domains.md:1857-1862`). The
